...
* For example, the Ruby interpreter itself (`ruby.exe`) is [embedded as one long string](https://github.com/larsch/ocra/blob/9c5fe287887f16db0c00ad54a549ff383f4c8d91/bin/ocra#L901) as the [first parameter](https://github.com/larsch/ocra/blob/9c5fe287887f16db0c00ad54a549ff383f4c8d91/bin/ocra#L1161) to the `OP_CREATEFILE` opcode.
...
writes an [`opcodes_offset`](https://github.com/larsch/ocra/blob/9c5fe287887f16db0c00ad54a549ff383f4c8d91/bin/ocra#L1077) value. This value is a pointer to the start of the opcodes that tells the
